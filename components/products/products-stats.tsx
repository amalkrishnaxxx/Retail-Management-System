...
import { ShoppingCart, Clock, Truck, CheckCircle2, Package, AlertTriangle, TrendingUp, DollarSign } from "lucide-react"
  ...
  const stats = [
    {
      ...
      iconBg: "bg-gradient-to-br from-sky-500 to-sky-600 shadow-lg shadow-sky-500/40",
    },
    {
      title: "Low Stock",
      value: "23",
