  ...
  const stats = [
    {
      ...
      iconBg: "bg-gradient-to-br from-blue-500 to-blue-600 shadow-lg shadow-blue-500/40",
    },
    {
    ...
    // },
    {
      ...
      change: "This month",
      trend: "up" as const,
      icon: <span className="h-5 w-5 text-purple-400">📈</span>, // Optional: Replace with an actual Lucide icon if needed
